...
_C.DATASET.LABELROOT = 'bdd/ll_det_annotations'      # the path of det_annotations folder
...
_C.TRAIN.ENC_DET_INS_SEG_ONLY = True      # Only train encoder + da ins segmentation task
